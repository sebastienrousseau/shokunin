...
/// use staticrux::modules::tags::generate_tags;
...
/// ```rust
/// use std::collections::HashMap;
/// use staticrux::modules::tags::create_tags_data;
///
/// let mut metadata = HashMap::new();
...
/// use staticrux::modules::tags::generate_tags_html;
///
...
/// ```rust
/// use std::path::Path;
/// use staticrux::modules::tags::write_tags_html_to_file;
///
