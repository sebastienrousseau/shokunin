...
public spaces. Examples include using an official email address, posting
...
be reported to the maintainers responsible for enforcement at
**<contact@sebastienrousseau.com>**.

All complaints will be reviewed and investigated promptly and fairly.
You should receive an acknowledgement within 72 hours, matching the
response window stated in [`SECURITY.md`](SECURITY.md).
