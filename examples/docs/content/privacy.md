...
date: "April 16, 2026"
description: "Privacy policy for the Polaris docs site."
download: ""
...
logo: ""
name: "Polaris"
permalink: "https://docs.polaris.example.com/privacy/"
rating: "general"
referrer: "no-referrer"
revisit-after: "7 days"
robots: "index, follow"
short_name: "kaishi"
subtitle: "What we collect, why, and how to delete it."
...
twitter_description: "Privacy policy for the Polaris docs site."
twitter_image: ""
...
This documentation site does not set cookies, run analytics, or include any third-party scripts. Server logs retain IP addresses for **14 days** for abuse prevention; nothing else is stored.

## What the Polaris service collects

See the main product privacy notice at <https://polaris.example.com/privacy>.

## Deletion

To request deletion of your account and all associated data, email privacy@polaris.example.com from the address on file. Deletion is processed within 30 days.
