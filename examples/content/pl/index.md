...
format-detection: "telephone=no" ## Wykrywanie formatu na witrynie.
...
keywords: "kaishi, static site generator, generator stron statycznych, minimalistyczny szablon strony, nowoczesny szablon strony, responsywny szablon strony, szablon startowy strony, freelancer kreatywny, założyciel startupu, właściciel małej firmy, obecność online" ## Słowa kluczowe witryny. (oddzielone przecinkami, maks. 10 słów kluczowych)
language: "pl-PL" ## Język witryny. (domyślnie: en-GB)
layout: "index" ## Układ witryny.
...
permalink: "https://kaishi.pl" ## Adres URL witryny.
...
news_title: "Kaishi, szablon startowy dla Static Site Generator" ## Tytuł strony. (maks. 64 znaki)
...
item_guid: "https://kaishi.pl"
item_link: "https://kaishi.pl"
...
ttl: "60"
type: "website"
webmaster: jane.doe@kaishi.pl (Jane Doe)
...
# Security - Metadane bezpieczeństwa (YAML).
security_contact: "mailto:jane.doe@kaishi.pl" ## Kontakt bezpieczeństwa strony.
security_expires: "Wed, 01 Jan 2025 01:01:01 GMT" ## Data wygaśnięcia strony.
# Pola opcjonalne:
security_acknowledgments: "Podziękowania dla zespołu Rust za wspaniałą pracę nad SSG." ## Podziękowania strony.
security_languages: "pl" ## Preferowane języki strony.
security_canonical: "https://kaishi.pl" ## Kanoniczny adres URL strony.
security_policy: "https://kaishi.pl/policy" ## Polityka strony.
security_hiring: "https://kaishi.pl/hiring" ## Oferty pracy strony.
security_encryption: "https://kaishi.pl/encryption" ## Szyfrowanie strony.

---

## Przegląd

**Kaishi** to minimalistyczny i nowoczesny szablon startowy dla [generatora stron statycznych SSG ⧉][0], zaprojektowany dla profesjonalistów, którzy cenią prostotę i elegancję.

Dzięki przejrzystemu i dynamicznemu układowi Kaishi oferuje wszechstronne i przyjazne dla użytkownika rozwiązanie dla wszystkich, którzy chcą zaprezentować swoją pracę i usługi online. Oparty na responsywnym frameworku, ten szablon jest idealny dla profesjonalistów bez umiejętności programowania lub projektowania.

Niezależnie od tego, czy jesteś freelancerem kreatywnym, założycielem startupu czy właścicielem małej firmy — gotowe do użycia, responsywne szablony startowe Kaishi stanowią doskonałą podstawę Twojej obecności online. Dzięki minimalistycznemu designowi Kaishi jest najlepszym szablonem startowym dla nowoczesnych i profesjonalnych witryn.

Ta strona jest przykładem dla generatora stron statycznych SSG. Możesz jej użyć jako szablonu dla swojej witryny lub bloga. Wykorzystuje szablon Markdown dla treści i niestandardowy motyw HTML dla układu.
