...
banner_alt: "las pełen zielonych drzew" ## Tekst alternatywny banera witryny.
...
date: "2023-07-12" ## Data strony.
description: "Możesz się z nami skontaktować, korzystając z poniższego formularza." ## Opis witryny. (maks. 160 znaków)
download: "" ## Adres URL pobierania produktu.
format-detection: "telephone=no" ## Wykrywanie formatu witryny.
form-id: "https://formspree.io/f/meqwylbe" ## Identyfikator formularza witryny.
...
keywords: "skontaktuj się z nami, formularz kontaktowy, napisz do nas, strona kontaktowa, informacje kontaktowe, obsługa klienta, wsparcie, opinie, pytania, zapytania, pomoc" ## Słowa kluczowe witryny. (maks. 160 znaków)
language: "pl-PL" ## Język witryny. (domyślnie: en-GB)
layout: "contact" ## Układ witryny.
...
permalink: "https://kaishi.pl/contact" ## Adres URL witryny.
...
subtitle: "Jak możemy Ci dziś pomóc?" ## Podtytuł strony. (maks. 64 znaki)
...
news_title: "Skontaktuj się z nami" ## Tytuł strony. (maks. 64 znaki)
...
item_title: "Skontaktuj się z nami"
...
apple-mobile-web-app-title: "Skontaktuj się z nami" ## Tytuł Apple Mobile Web App.
...
twitter_description: "Formularz kontaktowy Kaishi, szablonu startowego dla stron statycznych"
...
twitter_title: "Skontaktuj się z nami"
...
Masz pytanie, sugestię lub zapytanie biznesowe? Wypełnij poniższy formularz, a członek zespołu odpowie w ciągu 48 godzin.
