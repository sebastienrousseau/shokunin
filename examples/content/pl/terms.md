...
keywords: "warunki użytkowania, własność intelektualna" ## Słowa kluczowe witryny. (maks. 160 znaków)
...
permalink: "https://kaishi.pl/terms" ## Adres URL witryny.
...
tags: "warunki użytkowania, kaishi, static site generator, generator stron statycznych, własność intelektualna, strony powiązane, odpowiedzialność, prywatność, prawo właściwe, zmiany, kontakt" ## Tagi witryny. (maks. 160 znaków)
theme-color: "143, 250, 113" ## Kolor motywu witryny.
title: "Warunki użytkowania" ## Tytuł strony. (maks. 64 znaki)
...
news_title: "Warunki" ## Tytuł strony. (maks. 64 znaki)
...
item_guid: "https://kaishi.pl/terms/index.html"
item_link: "https://kaishi.pl/terms/index.html"
item_pub_date: "Wed, 01 Jan 2025 01:01:01 GMT"
item_title: "Warunki użytkowania"
...
Niniejsze Warunki i Zasady użytkowania ("Warunki użytkowania") dotyczą witryny SSG
(職人) znajdującej się pod adresem <https://kaishi.pl/> ("Witryna").

KORZYSTAJĄC Z WITRYNY, ZGADZASZ SIĘ NA NINIEJSZE WARUNKI UŻYTKOWANIA; JEŚLI SIĘ NIE ZGADZASZ, NIE KORZYSTAJ Z WITRYNY.

### Własność intelektualna

Witryna oraz jej oryginalna zawartość, funkcje i funkcjonalność są i pozostaną wyłączną własnością Kaishi. Niniejsza Witryna jest chroniona prawem autorskim Stanów Zjednoczonych i prawem międzynarodowym, znakami towarowymi i innymi przepisami.

### Linki do innych witryn oraz do witryny Kaishi

Nasza Witryna może zawierać linki do witryn internetowych osób trzecich ("Witryny powiązane") lub usług, które nie są własnością ani nie są kontrolowane przez Kaishi. Te Witryny powiązane są udostępniane wyłącznie dla wygody naszych odwiedzających.

Kaishi nie ma kontroli i nie ponosi odpowiedzialności za zawartość, politykę prywatności ani praktyki jakichkolwiek Witryn powiązanych lub usług. Nie gwarantujemy ofert żadnego z tych podmiotów/osób, ich witryn ani usług.

### Ograniczenie odpowiedzialności

KAISHI NIE OBIECUJE, ŻE WITRYNA LUB JAKAKOLWIEK ZAWARTOŚĆ, USŁUGA LUB FUNKCJA WITRYNY BĘDZIE WOLNA OD BŁĘDÓW LUB NIEPRZERWANA, ANI ŻE JAKIEKOLWIEK WADY ZOSTANĄ NAPRAWIONE, ANI ŻE KORZYSTANIE PRZEZ CIEBIE Z WITRYNY ZAPEWNI OKREŚLONE REZULTATY. WITRYNA I JEJ ZAWARTOŚĆ SĄ DOSTARCZANE NA ZASADZIE "TAKIE, JAKIE SĄ" I "W MIARĘ DOSTĘPNOŚCI". WSZYSTKIE INFORMACJE ZAMIESZCZONE NA WITRYNIE MOGĄ ULEC ZMIANIE BEZ POWIADOMIENIA. KAISHI NIE MOŻE ZAGWARANTOWAĆ, ŻE JAKIEKOLWIEK PLIKI LUB INNE DANE POBRANE Z WITRYNY BĘDĄ WOLNE OD WIRUSÓW, ZANIECZYSZCZEŃ LUB FUNKCJI NISZCZĄCYCH. KAISHI ODRZUCA WSZELKĄ ODPOWIEDZIALNOŚĆ ZA DZIAŁANIA, ZANIECHANIA I POSTĘPOWANIE JAKICHKOLWIEK OSÓB TRZECICH W ZWIĄZKU Z KORZYSTANIEM PRZEZ CIEBIE Z WITRYNY I/LUB USŁUG KAISHI. W ŻADNYM WYPADKU KAISHI ANI JEJ DYREKTORZY, PRACOWNICY, PARTNERZY, AGENCI, DOSTAWCY LUB PODMIOTY STOWARZYSZONE NIE BĘDĄ PONOSIĆ ODPOWIEDZIALNOŚCI ZA JAKIEKOLWIEK POŚREDNIE, PRZYPADKOWE, SZCZEGÓLNE, WTÓRNE LUB KARNE SZKODY, W TYM BEZ OGRANICZEŃ UTRATĘ ZYSKÓW, DANYCH, UŻYTKOWANIA, DOBREJ WOLI LUB INNE NIEMATERIALNE STRATY WYNIKAJĄCE Z DOSTĘPU LUB KORZYSTANIA BĄDŹ BRAKU MOŻLIWOŚCI DOSTĘPU LUB KORZYSTANIA Z WITRYNY.

## Prywatność

[Polityka prywatności](/privacy/index.html) Kaishi ma zastosowanie do korzystania z tej Witryny, a jej warunki stanowią część niniejszych Warunków użytkowania poprzez to odniesienie. Ponadto, korzystając z Witryny, potwierdzasz i zgadzasz się, że transmisje internetowe nigdy nie są całkowicie prywatne ani bezpieczne. Rozumiesz, że wszelkie wiadomości lub informacje wysyłane przez Ciebie do Witryny mogą zostać odczytane lub przechwycone przez inne osoby.

## Prawo właściwe

Niniejsze Warunki będą interpretowane i wdrażane zgodnie z prawem Stanów Zjednoczonych, z pominięciem wszelkich zapisów dotyczących kolizji prawa.

## Zmiany

Zastrzegamy sobie prawo, według własnego uznania, do zmiany, modyfikacji, dodawania lub usuwania części niniejszych Warunków użytkowania w dowolnym czasie. Twoim obowiązkiem jest okresowe sprawdzanie niniejszych Warunków użytkowania pod kątem zmian. Dalsze korzystanie z naszej Witryny po wejściu w życie jakichkolwiek zmian oznacza zgodę na przestrzeganie zmienionych warunków.

## Skontaktuj się z nami

Jeśli masz pytania dotyczące niniejszych Warunków, [skontaktuj się z nami](/contact/index.html)
