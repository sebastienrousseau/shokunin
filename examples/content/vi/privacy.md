...
keywords: "chính sách quyền riêng tư, kaishi, trình tạo trang tĩnh, trình tạo trang tĩnh, dữ liệu người dùng, google analytics, microsoft clarity, công cụ theo dõi, thông tin cá nhân, quyền lợi, thay đổi" ## Từ khoá của trang. (tối đa 160 ký tự)
...
permalink: "https://kaishi.vn/privacy" ## URL của trang.
...
news_title: "Quyền riêng tư" ## Tiêu đề của trang. (tối đa 64 ký tự)
...
item_guid: "https://kaishi.vn/privacy/index.html"
item_link: "https://kaishi.vn/privacy/index.html"
...
Chúng tôi không trực tiếp thu thập bất kỳ dữ liệu cá nhân nào từ bạn khi bạn duyệt trang web của chúng tôi. Chúng tôi không sử dụng cookie cho mục đích logic hoặc lưu bất kỳ thông tin cá nhân nào từ người dùng.

## Sử dụng các công cụ theo dõi

Chúng tôi sử dụng hai dịch vụ của bên thứ ba để giám sát và phân tích lưu lượng truy cập web: Google Analytics và Microsoft Clarity.

### Google Analytics

Google Analytics là một dịch vụ phân tích web do Google cung cấp, theo dõi và báo cáo lưu lượng truy cập trang web. Google sử dụng dữ liệu được thu thập để theo dõi và giám sát việc sử dụng Trang web của chúng tôi. Dữ liệu này được chia sẻ với các dịch vụ khác của Google. Để biết thêm thông tin về các thực hành quyền riêng tư của Google, vui lòng truy cập trang web Quyền riêng tư & Điều khoản của Google: [Quyền riêng tư & Điều khoản của Google ⧉](https://policies.google.com/privacy)

### Microsoft Clarity

Microsoft Clarity là một công cụ phân tích hành vi người dùng giúp chúng tôi hiểu cách người dùng tương tác với trang web của chúng tôi. Dữ liệu được thu thập bao gồm thông tin như chuyển động chuột, nhấp chuột và cuộn trang. Để biết thêm thông tin về các thực hành quyền riêng tư của Microsoft, vui lòng truy cập trang Tuyên bố Quyền riêng tư của Microsoft: [Tuyên bố Quyền riêng tư của Microsoft ⧉](https://privacy.microsoft.com/en-us/privacystatement)

## Quyền của bạn

Tuỳ thuộc vào nơi bạn cư trú, bạn có thể có một số quyền nhất định đối với dữ liệu cá nhân của mình, chẳng hạn như quyền yêu cầu truy cập, sửa đổi hoặc xoá dữ liệu của bạn, hoặc phản đối việc chúng tôi sử dụng dữ liệu của bạn.
...
Chúng tôi khuyên bạn nên xem lại Chính sách Quyền riêng tư này định kỳ để biết bất kỳ thay đổi nào. Các thay đổi đối với Chính sách Quyền riêng tư này có hiệu lực khi chúng được đăng trên trang này.
