...
keywords: "kaishi, SSG, modèle de site minimaliste, modèle de site moderne, modèle de site responsive, modèle de site de démarrage, freelance créatif, fondateur de startup, propriétaire de petite entreprise, présence en ligne" ## Les mots-clés du site. (séparés par des virgules, max 10 mots-clés)
...
news_title: "Kaishi, un modèle de démarrage pour le Static Site Generator" ## Le titre de la page. (max 64 caractères)
...
generator: "SSG (version 0.0.33)" ## Le générateur du flux RSS.
...
item_title: "Kaishi, un modèle de démarrage pour le Static Site Generator"
...
author_website: "https://cloudcdn.pro" ## Le site web de l'auteur.
...
site_software: "SSG, Rust" ## Le logiciel du site.
...
security_acknowledgments: "Merci à l'équipe Rust pour leur excellent travail sur SSG." ## Les remerciements de la page.
