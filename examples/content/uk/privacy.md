...
keywords: "політика конфіденційності, kaishi, генератор статичних сайтів, static site generator, дані користувачів, google analytics, microsoft clarity, інструменти відстеження, особиста інформація, права, зміни" ## Ключові слова сайту. (макс. 160 символів)
...
permalink: "https://kaishi.ua/privacy" ## URL сайту.
...
news_title: "Конфіденційність" ## Заголовок сторінки. (макс. 64 символи)
...
item_guid: "https://kaishi.ua/privacy/index.html"
item_link: "https://kaishi.ua/privacy/index.html"
...
Ми не збираємо безпосередньо жодних персональних даних від вас під час перегляду нашого сайту. Ми не використовуємо файли cookie для логіки та не зберігаємо жодної особистої інформації користувача.

## Використання інструментів відстеження

Ми використовуємо два сторонні сервіси для моніторингу та аналізу вебтрафіку: Google Analytics та Microsoft Clarity.

### Google Analytics

Google Analytics — це сервіс вебаналітики, який пропонує Google і який відстежує та звітує про трафік сайту. Google використовує зібрані дані для відстеження та моніторингу використання нашого сайту. Ці дані передаються іншим сервісам Google. Для отримання додаткової інформації про практики конфіденційності Google відвідайте вебсторінку «Політика конфіденційності та умови Google»: [Політика конфіденційності та умови Google ⧉](https://policies.google.com/privacy)

### Microsoft Clarity

Microsoft Clarity — це інструмент аналітики поведінки користувачів, який допомагає нам розуміти, як користувачі взаємодіють з нашим сайтом. Зібрані дані включають таку інформацію, як рухи миші, кліки та прокручування. Для отримання додаткової інформації про практики конфіденційності Microsoft відвідайте вебсторінку «Заява про конфіденційність Microsoft»: [Заява про конфіденційність Microsoft ⧉](https://privacy.microsoft.com/en-us/privacystatement)

## Ваші права

Залежно від місця проживання, ви можете мати певні права щодо ваших персональних даних, зокрема право запитувати доступ до них, виправлення чи видалення своїх даних, або заперечувати проти використання нами ваших даних.

## Зміни до цієї Політики конфіденційності

Ми можемо час від часу оновлювати нашу Політику конфіденційності. Ми повідомлятимемо вас про будь-які зміни, публікуючи нову Політику конфіденційності на цій сторінці.

Ми радимо вам періодично переглядати цю Політику конфіденційності на предмет змін. Зміни до цієї Політики конфіденційності набувають чинності з моменту їх публікації на цій сторінці.
