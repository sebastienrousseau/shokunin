...
banner_alt: "ліс, заповнений безліччю зелених дерев" ## Альтернативний текст банера сайту.
...
date: "2023-07-12" ## Дата сторінки.
description: "Ви можете зв'язатися з нами за допомогою контактної форми нижче." ## Опис сайту. (макс. 160 символів)
download: "" ## URL для завантаження продукту.
format-detection: "telephone=no" ## Виявлення формату сайту.
form-id: "https://formspree.io/f/meqwylbe" ## Ідентифікатор форми сайту.
...
keywords: "зв'язатися з нами, контактна форма, зв'язок, сторінка контактів, контактна інформація, обслуговування клієнтів, підтримка, відгуки, питання, запити, допомога" ## Ключові слова сайту. (макс. 160 символів)
language: "uk-UA" ## Мова сайту. (за замовчуванням: en-GB)
layout: "contact" ## Макет сайту.
...
permalink: "https://kaishi.ua/contact" ## URL сайту.
...
subtitle: "Як ми можемо вам сьогодні допомогти?" ## Підзаголовок сторінки. (макс. 64 символи)
tags: "зв'язатися з нами, контактна форма, зв'язок, сторінка контактів, контактна інформація, обслуговування клієнтів, підтримка, відгуки, питання, запити, допомога" ## Теги сайту. (макс. 160 символів)
theme-color: "143, 250, 113" ## Колір теми сайту.
title: "Зв'яжіться з нами" ## Заголовок сторінки. (макс. 64 символи)
...
news_title: "Зв'яжіться з нами" ## Заголовок сторінки. (макс. 64 символи)
...
apple-mobile-web-app-title: "Зв'яжіться з нами" ## Заголовок Apple-мобільного веб-застосунку сторінки.
...
twitter_description: "Контактна форма для Kaishi, стартового шаблону для статичних сайтів"
...
twitter_title: "Зв'яжіться з нами"
...
Маєте запитання, пропозицію чи бізнес-запит? Заповніть форму нижче, і хтось із нашої команди відповість вам протягом 48 годин.
