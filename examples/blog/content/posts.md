...
date: "April 16, 2026"
description: "Articles on accessibility, EAA compliance, and inclusive design."
download: ""
...
logo: ""
name: "Threshold"
permalink: "https://threshold.press/posts/"
rating: "general"
referrer: "no-referrer"
revisit-after: "7 days"
robots: "index, follow"
short_name: "kaishi"
subtitle: "Articles on accessibility, EAA compliance, and inclusive design."
...
twitter_description: "Articles on accessibility, EAA compliance, and inclusive design."
twitter_image: ""
...
- **[Designing for low-vision readers](/accessible-typography/)** — How type scale, line-height, and contrast affect users with low vision — with practical defaults you can ship today.
- **[EAA enforcement: a 12-point pre-launch checklist](/eaa-checklist/)** — The European Accessibility Act lands in June 2025. Here's the audit list we run on every site before signing it off.
- **[WCAG 2.2: what actually changed for builders](/wcag-2-1-vs-2-2/)** — Nine new criteria, three of them affect every form on the web. A practical translation from spec language to ship-it advice.

Subscribe to the [RSS feed](/rss.xml) or [Atom feed](/atom.xml) to follow new posts.
